...
const pdInfo2 = {
    pdImgList: [
        new URL("@/assets/imgs/pd2-1.jpg", import.meta.url).href,
        new URL("@/assets/imgs/pd2-2.jpg", import.meta.url).href,
        new URL("@/assets/imgs/pd2-3.jpg", import.meta.url).href,
    ],
